...
Для сборки потребуется "Arduino UNO" (или аналог), "LCD Keypad Shield" и "Data Logger Shield", на котором нужно подпаять немного сопротивлений и конденсаторов для входа и выхода.
