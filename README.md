...
Для сборки потребуется "Arduino UNO" (или аналог), "LCD Keypad Shield" и "Data Logger Shield", на котором нужно подпаять немного обычных сопротивлений и конденсаторов для входа и выхода. Никаких специфических плат или специнструментов не потребуется, все компоненты легко найти.

Для компиляции дополнительно к стандартным требуются библиотеки:
